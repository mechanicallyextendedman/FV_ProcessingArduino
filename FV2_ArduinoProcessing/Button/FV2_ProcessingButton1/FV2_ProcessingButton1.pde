// Use a button and an Arduino to control shapes in Processing
// The data from the sensor is assigned to buttonA
// buttonA can then be used to control anything between the asterisk lines in void draw
...
void serialEvent(Serial usbPort) {
  ...
  if (usbString != null) {
    ...
    if (firstContact == false) { 
      ...
      // ...to the "int buttonA" variable you declared at the beginning:

      // assign the value of sensor[1] to buttonA
      buttonA = sensor[1];
