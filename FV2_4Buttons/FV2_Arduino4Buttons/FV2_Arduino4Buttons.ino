...
int button4Pin = 11; // button on digital pin D11
...
int button4Val; // an empty variable to hold data from button4Pin
...
void setup() {
  ...
  digitalWrite(button4Pin, HIGH); // set button4Pin internal pullup resistor to HIGH
...
void loop() {
  ...
  button4Val = digitalRead(button4Pin); // assign button3Pin input to button3Val
  ...
  Serial.print(button4Val); // then the value of button4Pin (0 or 1)
  Serial.print(DELIMITER); // then ,
